...
public class SM3Digest {
	...
	private final int rotl(int value, int bits) {
		// 2011.5.25 renhongwei 经和pony确认，下面这种实现是正确的，等同与Integer.rotateLeft(value, bits)
	...
	public static void main(String[] args) {
		...
		// System.out.println("循环左移位测试 "
		// + Integer.toHexString(sm3.rotl(0xA3EF3A41, 3)).toUpperCase()
		// + "=1F79D20D\n");
		...
		// + Integer.toHexString(Integer.rotateLeft(t, 2))
		// + "\t"
		// + Integer.toHexString(Integer.rotateLeft(
		// Integer.rotateLeft(t, 1), 1)));
		// //
