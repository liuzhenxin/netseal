...
public class Constants {
	...
	public static final String SPLIT_3 = "<>"; // 分割符3
	...
	public static final long PHOTO_SIZE = 100; // 印模图片大小 KB
	...
	public static final String SCHEDULER_IDD = "SCHEDULER_IDD"; // 计划任务 ID
																// DELETE
	...
	public static final String WATCHDOG_PATH = ROOT_PATH + "watchdog/";
	public static final String WATCHDOG_CONF_PATH = WATCHDOG_PATH + "conf/";
	...
	public static final String RADS_DATA_PATH = ROOT_PATH + "rads/";
	...
	public static final String ENV = "netseal.env";
	...
	public static final String TABLE_SEAL_USER_TEMPLATE = "SEAL_USER_TEMPLATE";
	...
	public static final String LOG_OPTYPE_SERVERJKSCERTREQUEST = "serverJkscertrequest";
	public static final String LOG_OPTYPE_SERVERSM2CERTREQUEST = "serverSM2CertRequest";
	public static final String LOG_OPTYPE_SERVERJKSCERTIMPORT = "serverJksCertImport";
	public static final String LOG_OPTYPE_SERVERSM2CARDCERTREQUEST = "serverSM2CardCertRequest";
	public static final String LOG_OPTYPE_SERVERSM2CARDCERTIMPORT = "serverSM2CardCertImport";
	public static final String LOG_OPTYPE_SERVERPFXCERTIMPORT = "serverPfxCertImport";
	public static final String LOG_OPTYPE_SERVERSM2SIGNCERTIMPORT = "serverSM2SignCertImport";
	public static final String LOG_OPTYPE_SERVERSM2ENCCERTIMPORT = "serverSM2EncCertImport";
	public static final String LOG_OPTYPE_SERVERSM2CARDENCIMPORT = "serverSm2cardEncImport";
	...
	public static final String LOG_OPTYPE_RADSCONFIGSAVE = "radsConfigSave";
