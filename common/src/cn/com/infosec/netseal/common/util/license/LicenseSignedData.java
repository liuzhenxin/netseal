...
public class LicenseSignedData implements PKCSObjectIdentifiers {
	 ...
	 */
	public LicenseSignedData(byte[] in) throws SecurityException, CRLException, InvalidKeyException, NoSuchProviderException, NoSuchAlgorithmException {
		this(in, "INFOSEC");
	}
	 ...
	 */
	public LicenseSignedData(byte[] in, String provider) throws SecurityException, CRLException, InvalidKeyException, NoSuchProviderException, NoSuchAlgorithmException {
	 ...
	 */
	public LicenseSignedData(PrivateKey privKey, Certificate[] certChain, String hashAlgorithm) throws SecurityException, InvalidKeyException, NoSuchProviderException, NoSuchAlgorithmException {
	 ...
	 *            the provider to use.
	 */
	public LicenseSignedData(PrivateKey privKey, Certificate[] certChain, String hashAlgorithm, String provider)
	 ...
	 *            the provider to use.
	 */
	public LicenseSignedData(PrivateKey privKey, Certificate[] certChain, CRL[] crlList, String hashAlgorithm, String provider)
			throws SecurityException, InvalidKeyException, NoSuchProviderException, NoSuchAlgorithmException {
