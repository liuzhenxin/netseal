...
<body bgcolor="#FFFFFF">
	...
	<form name="free" action="pdfStampOK.jsp" method="post">
		<table width="60%" border="1" cellpadding="2" class="top"
			cellspacing="1" align="center" bgcolor="#00CCCC">
			<tr bgcolor="#CAEEFF">
				<td align=center colspan="2"><b>PDF盖章</b></td>
			</tr>
			<tr bgcolor="#CAEEFF">
				<td align=right style="width:25%">PDF：</td>
				<td style="width:80%"><input size="50" type="text" name="PDF_DATA">(部署Demo系统上的路径)</td>
			</tr>
			<tr bgcolor="#CAEEFF">
