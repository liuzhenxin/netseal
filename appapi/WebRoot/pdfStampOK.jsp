...
<%
	...
	if (!path.endsWith(Constants.PDF_SUFFIX))
		throw new Exception("PDF后缀必须是 " + Constants.PDF_SUFFIX);
	...
	pro.setProperty(Constants.PHOTO_DATA, base64Pd);
	...
	try {
		pdfStamp = NetSealClient.pdfStamp(pro);
