...
<body bgcolor="#FFFFFF">
	...
	<form name="free" action="updateSealPhotoOK.jsp" method="post">
		<table width="60%" border="1" cellpadding="2" class="top" cellspacing="1" align="center" bgcolor="#00CCCC">
			<tr bgcolor="#CAEEFF">
				<td align=center colspan="2"><b>更新印章图片</b></td>
			</tr>
			<!--  
			<tr bgcolor="#CAEEFF">
				<td align=right style="width:25%">帐号：</td> 
				<td style="width:80%"><input size="50" type="text" name="ACCOUNT"> (签章人)</td>
			</tr>
			<tr bgcolor="#CAEEFF">
				<td align=right style="width:25%">密码：</td>
				<td style="width:80%"><input size="50" type="text" name="PASSWORD"></td>
			</tr>
			-->
			<!--  
			<tr bgcolor="#CAEEFF">
				<td align=right style="width:25%">印模名称：</td>
				<td style="width:80%"><input size="50" type="text" name="TEMPLATE_NAME"></td>
			</tr>
			
			<tr bgcolor="#CAEEFF">
				<td align=right style="width:25%">图片：</td>
				<td style="width:80%"><input size="50" type="text" name="TEMPLATE_PHOTO">(本地路径 不填取印模配置图片)</td> 
			</tr>
			<tr bgcolor="#CAEEFF">
				<td align=right style="width:25%">生效时间：</td>
				<td style="width:80%"><input size="50" type="text" name="SEAL_NOTBEFOR">(2017-03-03 09:50:50)</td>
			</tr>
			<tr bgcolor="#CAEEFF">
				<td align=right style="width:25%">失效时间：</td>
				<td style="width:80%"><input size="50" type="text" name="SEAL_NOTAFTER">(2017-03-04 09:50:50)</td>
			</tr>
			-->
			<tr bgcolor="#CAEEFF">
			...
			<tr bgcolor="#CAEEFF">
				<td align=right style="width:25%">图片路径：</td>
				<td style="width:80%"><input size="50" type="text" name="PHOTO_DATA"></td>
			</tr>
			<tr bgcolor="#CAEEFF">
