...
public class OidUtil {
	...
	public static String getHashAlg(String signAlgOid) throws Exception {
		if (OidUtil.OID_SHA1withRSA.equals(signAlgOid))
			...
			throw new Exception("unknown sign oid: " + signAlgOid);
	}

	public static String getSignAlg(String signAlgOid) throws Exception {
		if (OidUtil.OID_SHA1withRSA.equals(signAlgOid))
	...
	public static String getSymAlg(String signAlgOid) throws Exception {
		if (OidUtil.OID_SHA1withRSA.equals(signAlgOid))
