					...
					<div class="x_panel">
						<div class="x_title" id="x_title">
							<div class="col-md-4 col-sm-4 col-xs-4">
								<input type="button" value="删除"  onclick="delPdf()"  class="btn btn-primary" style=" float:left; margin-left:10px;" data-target=".bs-example-modal-sm12"/>
							...
							<table class="table table-striped table-bordered dt-responsive nowrap">
								...
								<tbody>
									<c:forEach items="${files }" var="files">
										<tr>
											<td width="1"><input id="idp" name="checkboxt" class="input_checked" type="checkbox" value="${files.fileName }"></td>
...
<script type="text/javascript">
	...
	function delPdf(){
		...
		layer.confirm("确定要删除文件?",{btn:["确定","取消"]},function(){
			...
			$.ajax({
				url :"${ctx }/sealManage/pdfStamp/delPdf.do",
				type : "post",
				...
				success : function(data) {
					if(data.success){
						...
						loadTab("${ctx }/sealManage/pdfStamp/viewPdfFolder.do?ids=" + folder, "tab1");
					}else{
	...
	// 返回
	function back(){
		loadTab("${ctx }/sealManage/pdfStamp/pdfStampManage.do", "tab1");
	}
