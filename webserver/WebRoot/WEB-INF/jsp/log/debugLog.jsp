...
<div class="title clearfix">
	<h2 style="font-size:34px; font-weight:bold;">调试日志</h2>
</div>
<ul class="breadcrumb" style="">
	<li>
		<i class="fa fa-home"></i>
		<i style="color:rgb(42,63,84); font-style:normal;" id="bread">日志管理    /    调试日志</i>
	</li>
</ul>
...
$(function(){
	$('#tab1').load("${ctx }/log/debugLogFileList.do");
});
