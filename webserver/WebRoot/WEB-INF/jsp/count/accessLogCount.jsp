...
<div class="title clearfix">
	  ...
	  <ul class="breadcrumb" style="">
		 <li>
			...
			<i style="color:rgb(42,63,84); font-style:normal;" id="bread">统计    /    业务统计</i>
		</li>
	 </ul>
					...
					<div class="x_panel">
					   	<div class="x_content" id="tab1">
					   		...
					   		<form id="demo-form" class="form-horizontal form-label-left" style="margin-top:20px;" >
								<c:forEach var="accessLogCount" items="${accessLogCountList }" varStatus="s" >
								<div class="form-group">
									<label class="control-label col-xs-3">${accessLogCount.optype }次数
									</label>
									<div  class="col-xs-8">
									  <p  class="col-xs-8 showdetail">${accessLogCount.count }</p>
									</div>
								</div>
								</c:forEach>
