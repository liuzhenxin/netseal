...
<body>
	<div class="container" style=";margin:5% 3%;background-color:#3c8dbc;padding:5%;height:330px">
		<div style="float:right;width:60%;">
			<div class=" col-md-5 ">
				<div style="color:#e9f3ff;font-size:52px;font-weight:bold">SORRY!</div>
				<hr />
				<div style="color:crimson;font-size:16px;font-weight:bold">页面发生错误,请重试</div>
				<br />
		...
		<div align="center" style="display:inline;width:40%;float:right" class="row">
			<span style="font-size:120px;color:#e9f3ff">500</span>
		</div>
	</div>
</body>
</html>